...
# 4.) ATAC+RNA, without Harmony (n = 36) -- Only this for this script
# Plots are generate separately

#############################################
### 1.0 ATAC+RNA, without Harmony (n = 38) ###
#############################################
setwd("/storage/home/mfisher42/scProjects/CD_Subra/ArchR_Project/Multiome_07_2022/ArchR_07_2022/Filtered-Final-projIBD-ATACandGEX-07-2022/CLUSTS_UMAPS/NoHarmony_Combo")
### 1.1 load in data, build a dataframe ###

files <- list.files(path = "/storage/home/mfisher42/scProjects/CD_Subra/ArchR_Project/Multiome_07_2022/ArchR_07_2022/Filtered-Final-projIBD-ATACandGEX-07-2022/CLUSTS_UMAPS/NoHarmony_Combo",
                    pattern = ".csv")
