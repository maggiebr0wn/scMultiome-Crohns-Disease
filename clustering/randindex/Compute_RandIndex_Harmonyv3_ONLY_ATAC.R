...
# 07-15-2022
# Compute RandIndex for Harmonyv3 ONLY
# 1.) ATAC only, with Harmony (n = 108 total)  -- Only this for this script
# 2.) ATAC only, without Harmony (n = 36 total)
# 3.) ATAC+RNA, with Harmony (n = 108 total)
...
##############################################
### 1.0 ATAC only, with Harmonyv1 (n = 36) ###
##############################################
setwd("/storage/home/mfisher42/scProjects/CD_Subra/ArchR_Project/Multiome_07_2022/ArchR_07_2022/Filtered-Final-projIBD-ATACandGEX-07-2022/CLUSTS_UMAPS/Harmony_ATAC")

### 1.1 load in data, build a dataframe ###

files <- list.files(path = "/storage/home/mfisher42/scProjects/CD_Subra/ArchR_Project/Multiome_07_2022/ArchR_07_2022/Filtered-Final-projIBD-ATACandGEX-07-2022/CLUSTS_UMAPS/Harmony_ATAC",
                    pattern = ".csv")

# Only keep Harmonyv3 Files:
files <- str_subset(files, "Harmonyv3", negate = FALSE)
...
setwd("/storage/home/mfisher42/scProjects/CD_Subra/ArchR_Project/Multiome_07_2022/ArchR_07_2022/Filtered-Final-projIBD-ATACandGEX-07-2022/CLUSTS_UMAPS/Harmony_ATAC/RandIndex/Harmonyv3")
