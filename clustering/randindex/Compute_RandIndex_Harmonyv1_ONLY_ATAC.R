...
# 07-15-2022
# Compute RandIndex for Harmonyv1 ONLY
...
files <- str_subset(files, "Harmonyv1", negate = FALSE)
...
setwd("/storage/home/mfisher42/scProjects/CD_Subra/ArchR_Project/Multiome_07_2022/ArchR_07_2022/Filtered-Final-projIBD-ATACandGEX-07-2022/CLUSTS_UMAPS/Harmony_ATAC/RandIndex/Harmonyv1")
