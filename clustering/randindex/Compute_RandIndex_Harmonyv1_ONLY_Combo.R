...
##############################################
### 1.0 ATAC+GEX, with Harmonyv1 (n = 36) ###
##############################################
...
setwd("/storage/home/mfisher42/scProjects/CD_Subra/ArchR_Project/Multiome_07_2022/ArchR_07_2022/Filtered-Final-projIBD-ATACandGEX-07-2022/CLUSTS_UMAPS/Harmony_Combo/RandIndex/Harmonyv1")
