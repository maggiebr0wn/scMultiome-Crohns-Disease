...
cluster_files <- str_subset(cluster_files, "Harmonyv1", negate = FALSE)
...
umap_files <- list.files(path = "/storage/home/mfisher42/scProjects/CD_Subra/ArchR_Project/Multiome_07_2022/ArchR_07_2022/Filtered-Final-projIBD-ATACandGEX-07-2022/CLUSTS_UMAPS/UMAP_Coords/Harmony_Combo",
                            pattern = ".csv")
umap_files <- str_subset(umap_files, "Harmonyv1", negate = FALSE)
umaps <- gsub('.{4}$', '', umap_files)

names(umaps) <- clusters

### Loop through each UMAP/Cluster set for plots: ###
setwd("/storage/home/mfisher42/scProjects/CD_Subra/ArchR_Project/Multiome_07_2022/ArchR_07_2022/Filtered-Final-projIBD-ATACandGEX-07-2022/CLUSTS_UMAPS/Harmony_Combo/RandIndex/Harmonyv1/Plots")
