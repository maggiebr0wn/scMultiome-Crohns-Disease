...
markerTest <- getMarkerFeatures(
        ...
        useGroups = "Group_A",
        bgdGroups = c("Group_B", "Group_C", "Group_D")
)

sigMarkers <- getMarkers(markerTest, cutOff = "FDR <= 0.05 & abs(Log2FC) >= 0.25") # get signif

filename <- "/storage/home/mfisher42/scProjects/CD_Subra/Subset_Specific_DEGs_DARs/All_DARs_04112023/T_Cells/GroupA_DARs.csv"
write.csv(sigMarkers$Group_A, file = filename)
