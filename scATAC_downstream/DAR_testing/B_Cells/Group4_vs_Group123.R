...
markerTest <- getMarkerFeatures(
        ...
        useGroups = "Group_4",
        bgdGroups = c("Group_1", "Group_2", "Group_3")
)

sigMarkers <- getMarkers(markerTest, cutOff = "FDR <= 0.05 & abs(Log2FC) >= 0.25") # get signif

filename <- "/storage/home/mfisher42/scProjects/CD_Subra/Subset_Specific_DEGs_DARs/All_DARs_04112023/B_Cells/Group4_DARs.csv"
write.csv(sigMarkers$Group_4, file = filename)
