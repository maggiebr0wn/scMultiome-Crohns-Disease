...
markerTest <- getMarkerFeatures(
        ...
        useGroups = "Group_1",
        bgdGroups = c("Group_2", "Group_3", "Group_4")
)

sigMarkers <- getMarkers(markerTest, cutOff = "FDR <= 0.05 & abs(Log2FC) >= 0.25") # get signif

filename <- "/storage/home/mfisher42/scProjects/CD_Subra/Subset_Specific_DEGs_DARs/All_DARs_04112023/B_Cells/Group1_DARs.csv"
write.csv(sigMarkers$Group_1, file = filename)
