...
markerTest <- getMarkerFeatures(
        ...
        useGroups = "Group_3",
        bgdGroups = c("Group_1", "Group_2", "Group_4")
)

sigMarkers <- getMarkers(markerTest, cutOff = "FDR <= 0.05 & abs(Log2FC) >= 0.25") # get signif

filename <- "/storage/home/mfisher42/scProjects/CD_Subra/Subset_Specific_DEGs_DARs/All_DARs_04112023/B_Cells/Group3_DARs.csv"
write.csv(sigMarkers$Group_3, file = filename)
