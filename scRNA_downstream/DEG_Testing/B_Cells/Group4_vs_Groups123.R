...
# 03-31-2023
# Run MAST on Group4 vs Groups 1,2,3
...
ident1 <- c("Crohns_11", "Healthy_1", "Crohns_1",
	    "Crohns_18", "Healthy_7", "Healthy_9", 
	    "Crohns_9", "Crohns_16", "Crohns_14",
	    "Crohns_6")

ident2 <- setdiff(unique(bcells$Status_Donor), ident1)

degs <- MAST_runfun(bcells, assay = "OriginalRNA",
                    ident.1 = ident1,
                    ident.2 = ident2,
...
setwd("/storage/home/mfisher42/scProjects/CD_Subra/Subset_Specific_DEGs_DARs/All_DEGs_03312023/B_Cells")

write.csv(sig_degs, file = "Group4_DEGs.csv")
